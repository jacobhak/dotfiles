;;; simple-red-theme-dark.el --- Theme 

;; Copyright (C) 2016 , jacobhak
...
;;; Code:
 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   `(whitespace-tab ((,class (:background ,warning))))
   `(cursor ((,class (:background ,keyword))))
    `(show-paren-match-face ((,class (:background ,keyword))))
    `(isearch ((,class (:bold t :foreground ,warning :background ,bg3))))
    `(sml/filename ((,class (:foreground ,fg1 :weight bold))))
        ...
        `(org-level-1 ((,class (:bold t :foreground ,fg2 :height 2.0))))
        ...
        `(org-todo ((,class (:foreground ,keyword :bold t :background ,bg1))))
        `(org-done ((,class (:bold t :foreground ,bg4 :background ,bg1))))
...
(provide-theme 'simple-red-dark)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; simple-red-theme.el ends here
